...
const Header = ({ server }: { server: ServerWithMemberWithProfiles }) => (
...
const BodyDropDownMenu = ({
  ...
  server: Server;
  member: Member;
  setLoadingId: Function;
  onOpen: Function;
  router: routerProps;
}) => {
  const roles = Object.values(MemberRole).filter((role) => role !== "ADMIN");
